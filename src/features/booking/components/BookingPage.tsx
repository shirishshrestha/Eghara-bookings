...
import { Calendar, Clock, CreditCard, Check, ChevronLeft, AlertCircle } from 'lucide-react';
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-sm text-text-tertiary mt-1">One-time booking</p>
                  </div>
                </button>
                <button
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-sm text-text-tertiary mt-1">Select dates</p>
                  </div>
                </button>
                <button
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-sm text-text-tertiary mt-1">Weekly/Monthly</p>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              {bookingType === 'multiple' && (
                <div className="space-y-4">
                  <p className="text-text-tertiary">Select multiple dates for your bookings</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-text-tertiary">Digital wallet</p>
                    </div>
                  </div>
                  {paymentMethod === 'esewa' && <Check className="w-5 h-5 text-primary" />}
                </button>
                ...
                >
                  ...
                  {paymentMethod === 'khalti' && <Check className="w-5 h-5 text-primary" />}
                </button>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-text-tertiary">Bank transfer</p>
                    </div>
                  </div>
                  {paymentMethod === 'connectips' && <Check className="w-5 h-5 text-primary" />}
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div className="flex gap-4 mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-text-tertiary">Lalitpur, Kathmandu</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-text-tertiary">Service fee (10%)</span>
                    <span>NPR {serviceFee.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between font-medium pt-3 border-t border-divider">
                    <span>Total (NPR)</span>
                    <span className="text-primary text-xl">NPR {total.toLocaleString()}</span>
                  </div>
                </div>
