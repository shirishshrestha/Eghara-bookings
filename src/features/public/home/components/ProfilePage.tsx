...
const reviews = [
  ...
  },
  {
    ...
    date: "2 weeks ago",
    comment:
      "Good facilities overall. The parking was convenient. Would book again!",
...
const similarVenues = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1708472329334-c0550c39dba6?w=400&h=300&fit=crop",
    rating: 4.9,
    price: 3000,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1723074832950-9fb031b0f4ec?w=400&h=300&fit=crop",
    rating: 4.6,
    price: 2200,
  },
  {
    ...
    location: "Bhaktapur",
    image:
      "https://images.unsplash.com/photo-1723231462004-069caa209740?w=400&h=300&fit=crop",
    rating: 4.7,
    price: 2800,
  },
];
...
export function ProfilePage({ futsalId }: ProfilePageProps) {
  ...
  const handleBooking = () => {
    if (selectedDate && selectedTime) {
      router.push(
        `/booking/${futsalId}?date=${selectedDate.toISOString()}&time=${selectedTime}`
      );
    }
  };
            ...
            <Card className="mb-6">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Elite Futsal Arena is a premium indoor futsal facility located
                  in the heart of Lalitpur. Our state-of-the-art court features
                  professional-grade artificial turf, excellent lighting, and
                  modern amenities to ensure the best playing experience.
                </p>
                <p className="text-muted-foreground">
                  Perfect for both casual games and competitive matches, we
                  offer flexible booking options and competitive pricing. Our
                  facility includes changing rooms, shower facilities, parking,
                  and a cafeteria.
                </p>
              </CardContent>
            </Card>
